    ...
    <main class="content-area">
      <aside class="sidebar-nav">
        <div class="user-profile">
          <img src="https://files.antena2.com/antena2/public/2025-04/dayromorenooncecaldas.jpg?VersionId=kVrAVP4t9790zryZ1G3swopdGlbfAoZh" alt="User Avatar" class="avatar">
          <div class="user-info">
...
<div class="logout-section">
  <a class="nav-button logout" href="/ing_estudiantes"><!-- o la ruta que desees -->
